 ...
 */
public class MomBabyFragment extends Fragment implements RequestListener{
    private final String TAG=MomBabyFragment.class.getSimpleName();
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 2:
                    Log.e("error","网络请求失败");
//                            ((InformationCollectionActivity) getActivity()).showToast("网络请求失败");
                    break;
            }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        biz.getInformation(0, 2, 1, 10, TAG, this);
    }
